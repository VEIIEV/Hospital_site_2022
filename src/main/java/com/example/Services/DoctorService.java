...
public class DoctorService {
    ...
    //site
    public List<Doctor> getDoctorBySpecialisationNoApi(Specialisation specialisation) {
        return doctorRepository.findAllBySpecialisation(specialisation);
    }

    public List<Doctor> getSortedDoctorBySpecialisationNoApi(String title, Specialisation specialisation) {
        List<Doctor> doctors;
        doctors = doctorRepository.findAll(Sort.by(title).ascending());
        return doctors;
    }


    public Doctor getDoctorNoApi(Long id) throws NoSuchElementException {
